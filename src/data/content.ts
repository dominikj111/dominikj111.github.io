...
export const CONTENT_ITEMS: ContentItem[] = [
  // ── Pinned / Featured — custom order, Weaver Desktop last ────────────────
  {
    id: 'engram',
    type: 'project',
    title: 'Engram',
    ...
    tags: ['ai', 'deterministic', 'graph', 'reasoning', 'rust', 'symbolic-ai'],
  ...
  },
  {
    ...
    tags: ['architecture', 'language-agnostic', 'microkernel', 'modular', 'offline-first', 'oss'],
  ...
  },
  {
    ...
    tags: ['crate', 'jigsawflow', 'published', 'registry', 'rust', 'singleton'],
  ...
  },
  {
    ...
    tags: ['desktop', 'egui', 'embedded', 'iot', 'linux', 'raspberry-pi', 'rust'],
  ...
  // ── Articles / Projects / References — month desc, then Project/Article/Reference, then tags ──
  {
    ...
    tags: ['graphql', 'learning', 'react', 'typescript', 'visual-builder'],
    createdAt: '2026-04-01',
  ...
  },
  {
    ...
    tags: ['agent-mesh', 'architecture', 'deterministic', 'engram', 'llm', 'mcp', 'operations'],
    createdAt: '2026-04-13',
    slug: 'engram-deterministic-operations-layer-for-llm-agent-workflows',
  },
  {
    id: 'article-jigsawflow-composition',
    type: 'article',
    title: 'From Factory Floor to Codebase: Application Composition with JigsawFlow',
    description:
      'Replace concrete imports with capability contracts and a flat registry — no DI framework, no configuration files. The result: isolated module testing without mocking scaffolding, practical hot-swapping, and a foundation for polyglot composition across languages.',
    content:
      'JigsawFlow is an architectural pattern, not a framework. It inverts the dependency direction: instead of importing concrete types, modules define contracts (traits in Rust) and resolve implementations through a flat shared registry at runtime. The registry is the only shared dependency — no DI container, no configuration files.\n\nThe pattern draws from industrial automation: PLC systems and automotive ECUs have operated through standardised interfaces and hot-swappable modules for decades. JigsawFlow brings that discipline to general-purpose software, with practical payoffs in testing (no mocking scaffolding), runtime swappability, and a path toward polyglot composition across language boundaries.',
    tags: ['architecture', 'composition', 'jigsawflow', 'microkernel', 'pattern', 'rust'],
    createdAt: '2026-04-13',
    slug: 'capability-driven-module-composition-in-rust',
  },
  {
    id: 'eduapps',
    type: 'project',
    ...
    tags: ['browser-app', 'education', 'javascript', 'kids', 'math'],
    createdAt: '2026-03-01',
  ...
  },
  {
    ...
    tags: ['browser-app', 'gallery', 'javascript', 'kids'],
    createdAt: '2026-03-01',
  ...
  },
  {
    ...
    tags: ['computer-vision', 'machine-learning', 'playwright', 'python', 'sklearn', 'testing'],
    createdAt: '2026-02-01',
  ...
  },
  {
    ...
    tags: ['javascript', 'npm', 'published', 'typescript', 'utility'],
    createdAt: '2026-02-01',
  ...
  },
  {
    ...
    tags: ['devops', 'docker', 'laravel', 'php', 'saas', 'wave'],
  ...
  },
  {
    ...
    tags: ['desktop', 'gui', 'iced', 'reference', 'rust', 'theming'],
  ...
  },
  {
    ...
    tags: ['async', 'javascript', 'npm', 'promise', 'published', 'typescript'],
  ...
  },
  {
    ...
    tags: ['ai', 'diffusion', 'docker', 'jupyter', 'llm', 'python'],
  ...
  },
  {
    ...
    tags: ['markdown', 'reference', 'writing'],
  ...
  },
  {
    ...
    tags: ['design-system', 'monorepo', 'radix-ui', 'react', 'typescript'],
    createdAt: '',
